-- ============================================================
-- PROPER RLS SETUP - Using profiles table for admin checks (Fixed)
-- ============================================================
...
DROP POLICY IF EXISTS "locations_admin" ON business_locations;
...
DROP POLICY IF EXISTS "biz_categories_admin" ON business_categories;
